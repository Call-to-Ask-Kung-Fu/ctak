...
urlpatterns = patterns('',
    ...
    url(r'^producer_info/$', views.producer_info, name='producer_info'), url(r'^(?P<producer_id>\d+)/$', views.producer_info, name='producer_info'),
    url(r'^producer_detail/$', views.producer_detail, name='producer_detail'),
